...
public class SearchCrawler implements Runnable {
	...
	private String downloadPage(URL pageUrl) {
		try {
			// Open connection to URL forreading.
			 ...
			 HttpURLConnection c = (HttpURLConnection) pageUrl.openConnection();
	...
	public static void main(String[] args) {
		...
		//args = new String[]{"http://www.baidu.com/s?word=java","20", "java"};
		args = new String[]{"http://www.sina.com","20", "java"};
		if (args.length != 3) {
			System.out
