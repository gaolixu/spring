package com.intervalintl.algorithm;
...
public class HexConverter {
	 private final static char[] mChars = "0123456789ABCDEF".toCharArray();  
	    ...
	    public static void main(String[] args) throws Exception {
	    	String hex= "F8F0F4F2F1F2F1F0F0F8F8F2F0F0F2F640404040404040404040404040404040";
	    	String num="8042121008820026";
	    	String number="8042121813651111";
	    	
	    	String number2="8042121008820026";
	    	System.out.println(hexStr2Str(hex));
	    	System.out.println(unicodeToString(hex));
	    	
	    	System.out.println(str2HexStr(number));
	    	System.out.println(strToUnicode(number));
	    	
	    	System.out.println(str2HexStr(number2));
	    	System.out.println(strToUnicode(number2));
	    	
	    	System.out.println(String.valueOf(hexStr2Bytes(hex)));
