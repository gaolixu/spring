...
<div class="container">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <a class="btn  btn-sm" href="<%=request.getContextPath()%>/" role="button">主页</a>
            <a class="btn btn-primary btn-sm" href="<%=request.getContextPath()%>/blog/write" role="button">写博客</a>
        </div>
        ...
        <table class="table">
            ...
            <c:forEach begin="0" var="article" items="${articles}" step="1">
                <tr>
                    ...
                    <td><a href="<%=request.getContextPath()%>/blog/update/${article.id}">修改</a></td>
                    <td><a href="<%=request.getContextPath()%>/blog/delete/${article.id}">删除</a></td>
                </tr>
            </c:forEach>
        </table>
    </div>
