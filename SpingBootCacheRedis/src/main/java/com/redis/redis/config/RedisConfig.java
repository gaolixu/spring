...
import com.redis.redis.cache.CustomizedRedisCacheManager;
import com.redis.redis.serializer.FastJsonRedisSerializer;
import com.redis.redis.serializer.StringRedisSerializer;
...
public class RedisConfig {
    ...
    public RedisTemplate<String, Object> redisTemplate(RedisConnectionFactory redisConnectionFactory) {
        ...
        // 建议使用这种方式，小范围指定白名单
        ParserConfig.getGlobalInstance().addAccept("com.redis.");
