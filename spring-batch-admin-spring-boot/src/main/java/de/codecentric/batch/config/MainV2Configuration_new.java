...
/*@ImportResource({
    ...
    "classpath*:/META-INF/batch/admin/ds-context.xml"

    })*/
public class MainV2Configuration_new {
    
   /* @Bean
    public static PropertySourcesPlaceholderConfigurer propertySourcesPlaceholderConfigurer() { 
        
    	Resource[] resources = {
	            new ClassPathResource("batch-oracle.properties"),
	            new ClassPathResource("salestax-config.properties"),
	            new FileSystemResource("${user.home}/.settings/stw-config.properties"),
	            new FileSystemResource("${user.home}/.settings/stb-config.properties"),
	            new FileSystemResource("${user.home}/.settings/stw-credentials.properties"),
	        };
	        
        
        classpath:salestax-config.properties",
        "file:${user.home}/.settings/stw-config.properties",
        "file:${user.home}/.settings/stw-credentials.properties"
